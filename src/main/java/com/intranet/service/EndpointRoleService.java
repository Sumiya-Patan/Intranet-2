...
//         // Get all required permissions for this path+method from DB
//         List<String> requiredPermissions = endpointRoleRepository
//                 .findByPathAndMethod(normalizedPath, method.toUpperCase())
//                 .stream()
//                 .map(EndpointRole::getPermission)   // use permission column
//                 .toList();
