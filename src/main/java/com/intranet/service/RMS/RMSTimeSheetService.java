...
public class RMSTimeSheetService {
    ...
    public TimeSheetSummaryResponseDTO getSummary(
        ...
        for (Map.Entry<Long, List<TimeSheet>> entry : timeSheetsByUser.entrySet()) {
            ...
            BigDecimal userInternalHours = sumEntryHours(userEntries, entry2 -> entry2.getProjectId() != null && internalProjectIds.contains(entry2.getProjectId()));
            ...
            double utilizationPercentage = safePercentage(userTotalHours, plannedCapacity);
            ...
            resourceSummaries.add(ResourceSummaryDTO.builder()
                    ...
                    .internalHours(userInternalHours)
